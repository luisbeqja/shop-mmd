...
window.addEventListener("load", () => {
  if ($(window).width() <= 700) {
    $("#imgTop1").attr("src", "./foto/sfondoMobile1.png ");
    $("#imgTop2").attr("src", "./foto/sfondoMobile2.png ");
  } else {
    $("#imgTop1").attr("src", "./foto/slider-1-home-5.png ");
    $("#imgTop2").attr("src", "./foto/slider-1-home-2.png");
  }
});
